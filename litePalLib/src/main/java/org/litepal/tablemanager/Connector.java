...
public class Connector {
    ...
    public synchronized static SQLiteDatabase getWritableDatabase() {
        ...
        Log.i("AAAA","******************************:"+LitePalApplication.getPassKey());
        return litePalHelper.getWritableDatabase(LitePalApplication.getPassKey());
    }
    ...
    public static void clearLitePalOpenHelperInstance() {
        if (mLitePalHelper != null) {
            mLitePalHelper.getWritableDatabase(LitePalApplication.getPassKey()).close();
            mLitePalHelper = null;
        }
    }
